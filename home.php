...
<body>
  ...
  <div class="container">
    <div class="row">
      ...
      <!-- Tab 1 -->
      <div class="col-md-4">
        <h3 class="white-text">Nyeste lektier</h3>
      ...
      <!-- Tab 2 -->
      <div class="col-md-4">
        <h3 class="white-text">Nyheder</h3>
        <div class="list-group">
          <!-- Query start -->
          <?php
        //   $curl = curl_init();
        ...
        //     CURLOPT_URL => "83.151.132.131:8000/API/1/news/all",
      ...
      <div class="col-md-4">
        ...
        <ul class="list-group">
          ...
          <li class="list-group-item"><a data-target="#opretLektie" data-toggle="modal" class="MainNavText" id="MainNavHelp" 
       href="#opretLektie"><i class="fas fa-plus"></i> <i class="fas fa-archive"></i> Opret lektie</li></a>
          <li class="list-group-item"><a href="#"><i class="fas fa-plus"></i> <i class="fas fa-newspaper"></i> Opret nyhed</li></a>
        </ul>
